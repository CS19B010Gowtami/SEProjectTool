...
#   NESTED CONDITION
    ...
    # def cond(self, p):
    #     return p.ID != p.NUMS
    @_('UPDATE table_name SET col_assigns where_stmt SEMICOLON')
    ...
    @_('DELETE FROM table_name where_stmt SEMICOLON')
